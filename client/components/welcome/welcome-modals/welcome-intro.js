  ...
  return (
    <div>
      ...
      <div id='buttonsContainer'>
        <RaisedButton onClick={props.handleWelcomeVersion.bind(null, 'NoSQL', false)} buttonStyle={styles}>
          NoSQL
        </RaisedButton>
        <RaisedButton onClick={props.handleWelcomeVersion.bind(null, 'SQL', false)} buttonStyle={styles}>
          SQL
        </RaisedButton>
      </div>
    </div>
